...
<html lang="en">
  <head>
    ...
    <title>Kiuki Tours &amp; Transportation Ltd &#8211; The Impossible just takes a little longer.</title>
...
<!-- Datepicker CSS -->
<link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/smoothness/jquery-ui.min.css" type="text/css"/>
  ...
  <div class="top-header">
	<div class="row row-flex justify-content-center align-items-center text-center">
	  ...
	  <ul class="inline-items">
								...
								<li class="icon-list-item"><a href="https://www.google.com/maps/place/Kiuki+Tours/@18.4590003,-77.9217018,17z/data=!3m1!4b1!4m5!3m4!1s0x8eda2a85ca60245d:0x56ba2a0872ebf6c7!8m2!3d18.4589952!4d-77.9195131">
								<span class="icon-list-icon"><i aria-hidden="true" class="fas fa-map-marked-alt"></i></span>
	  ...
	  <a href="https://darksky.net/forecast/18.2787,-78.3465/us12/en" target="_blank" rel="nofollow noopener"><span class="weather-day weather-current"><span class="weather_date">Thursday</span> <i class="wi wi-night-cloudy"></i> <em class="weather-temp">26 °C</em></span></a>
	  </div>
	  </div>
...
<nav class="navbar-expand-sm navbar-block">
  ...
  <div class="col-md-4">
  <div class="logo">
  <a href="index.html"><img src="{{ asset('assets/web/images/kiuki-tours-logo-1-ws.svg') }}" alt="Kiuki Tours &amp; Transportation Jamaica" title="Kiuki Tours &amp; Transportation Jamaica" itemprop="logo" /></a>
  </div>
  </div>
  <div class="col-8">
	<div class="collapse navbar-collapse align-items-end justify-content-end" id="navbarCollapse">
	<ul class="navbar-nav align-items-center">
	  ...
	  <li class="nav-item">
		<a href="#" title="Shopping Cart">
			<img src="{{ asset('assets/web/images/cart.png') }}" alt="cart" /><span class="menu-item-count"><i class="fas fa-caret-left"></i>0</span>
		</a>
	  </li>
	  <li class="nav-item">
		...
		<div class="search-divblock">
			<form role="search" method="get" id="searchform" class="searchform" action="https://kiukitours.com/">
				<input type="search" class="searchform-input" name="s" value="" placeholder="Search …" title="Press enter to search">
	...
	<div class="container">
		<div class="d-flex justify-content-between align-items-center mobile-nav-row">
			<div class="mobile-one-half">
				...
				<a href="index.html"><img src="{{ asset('assets/web/images/kiuki-tours-logo-ws.svg') }}" alt="Kiuki Tours &amp; Transportation Jamaica" title="Kiuki Tours &amp; Transportation Jamaica" itemprop="logo" /></a>
				</div>
			</div>
			<div class="mobile-one-half">
			<ul class="d-flex justify-content-end align-items-center mobile-navul">
			  <li>
				<a href="#" title="Shopping Cart">
					<img src="{{ asset('assets/web/images/cart-icon.png') }}" alt="cart" /><span class="menu-item-count"><i class="fas fa-caret-left"></i>0</span>
				</a>
			  </li>
			  <li>
				<a class="search-link" href="#" title="search">
			  ...
			  <li>
				<a href="#responsive_menu" class="mobile-main navbar-toggle mobile-menu-toggle"><i class="fas fa-align-justify"></i></a> 
...
<div class="col-md-6">
<div class="text-clearfix">Powered by <a href="#" rel="nofollow" style="color: #fff;"><strong>Salcon</strong></a>.</div>
</div>
</div>
</div>
</div>
