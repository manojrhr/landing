...
<head>
    ...
    <meta name="title" content="{!! get_component('home_meta_title') !!}">
                    ...
                    <div class="col-md-5">
                        <ul class="inline-items">
                            <li class="icon-list-item">
                                ...
                                <li class="icon-list-item">
                                <span class="icon-list-icon"><i aria-hidden="true" class="fas fa-user-clock"></i></span>
                                <span class="icon-list-text"> 24 Hour Support Available</span></li>
                                
                            <li class="icon-list-item"><a
                                    href="{{ get_component('map_link') }}"  target="_blank">
                ...
                <div class="container">
                    <div class="d-flex flex-wrap footer-row">
                        <div class="div-one">
                            ...
                            <div class="tel-block">
                                <a href="tel:{{ get_component('phone_primary') }}">{{ get_component('phone_primary') }}</a></div>
