                ...
                <div class="left-airport-transfers">
                    ...
                    <div id="book-airport-transfers-form" class="book-airport-transfers-form">
                        ...
                        <div class="form-row-block">
                            ...
                            <div class="select-form-input-div">
                                <select class="form-control select2">
                                    <option value="negril" data-select2-id="2530">Azul Sensatori Resort | Negril
                                    </option>
                                    <option value="negril">Bar-Be-Barn | Negril</option>
                                    <option value="negril">Beach House Villas &amp; Hotel | Negril</option>
                                    <option value="negril">Beachcomber Hotel | Negril</option>
                                    <option value="ocho rios">Beaches Boscobel Resort &amp; Golf | Ocho Rios</option>
                                    <option value="negril">Beaches Negril Resort &amp; Spa | Negril</option>
                                    <option value="negril">Beaches Sandy Bay | Negril</option>
                                    <option value="ocho rios">THE Bird's Eye View | Ocho Rios</option>
                                    <option value="negril">Blue Cave Castle | Negril</option>
                                    <option value="ocho rios">Blue Harbour | Ocho Rios</option>
                                    <option value="negril">Bourbon Beach | Negril</option>
                                    <option value="montego bay">Breathless Montego Bay Resort &amp; Spa | Montego Bay
                                    </option>
                                    <option value="trelawny">Breezes Resort &amp; Spa Trelawny | Trelawny</option>
                                    <option value="negril">Carib Beach Apartments | Negril</option>
                                    <option value="montego bay">Caribbean Fairways | Montego Bay</option>
                                    <option value="negril">Caribbean Sunset Resort | Negril</option>
                                    <option value="montego bay">Caribic House | Montego Bay</option>
                                    <option value="montego bay">Cariblue Beach Hotel | Montego Bay</option>
                                    <option value="negril">Catch A Falling Star Gardens | Negril</option>
                                    <option value="negril">Charela Inn | Negril</option>
                                    <option value="ocho rios">Chrisann's Beach Resort | Ocho Rios</option>
                                    <option value="negril">Chuckles Resort | Negril</option>
                                    <option value="runaway bay">Club Ambiance | Runaway Bay</option>
                                    <option value="negril">Club RIU Negril | Negril</option>
                                    <option value="negril">Coco La Palm | Negril</option>
                                    <option value="montego bay">Coral Cliff Hotel | Montego Bay</option>
                                    <option value="negril">Coral Seas Beach Resort | Negril</option>
                                    <option value="negril">Coral Seas Cliff | Negril</option>
                                    <option value="negril">Coral Seas Garden | Negril</option>
                                    <option value="negril">Cotton Tree Place | Negril</option>
                                    <option value="negril">Country Country Beach Cottages | Negril</option>
                                    <option value="negril">Couples Negril | Negril</option>
                                    <option value="ocho rios">Couples Sans Souci | Ocho Rios</option>
                                    <option value="negril">Couples Swept Away Negril | Negril</option>
                                    <option value="ocho rios">Couples Tower Isle | Ocho Rios</option>
                                    <option value="montego bay">Coyaba Beach Resort &amp; Club | Montego Bay</option>
                                    <option value="ocho rios">Crane Ridge | Ocho Rios</option>
                                    <option value="ocho rios">Crystal Ripple Beach Lodge | Ocho Rios</option>
                                    <option value="negril">Crystal Water Villas | Negril</option>
                                    <option value="negril">Daniel Village Resort | Negril</option>
                                    <option value="negril">Devine Destiny | Negril</option>
                                    <option value="montego bay">Doctor's Cave Beach | Montego Bay</option>
                                    <option value="negril">Drumville Cove | Negril</option>
                                    <option value="montego bay">El Greco All Suites Resort | Montego Bay</option>
                                    <option value="ocho rios">Emerald Seas | Ocho Rios</option>
                                    <option value="montego bay">Emerald View Resort Villa | Montego Bay</option>
                                    <option value="montego bay">Fairway Manor | Montego Bay</option>
                                    <option value="runaway bay">FDR Pebbles Resort | Runaway Bay</option>
                                    <option value="negril">Firefly Beach Cottages | Negril</option>
                                    <option value="trelawny">Fisherman's Inn | Trelawny</option>
                                    <option value="ocho rios">Fisherman's Point Resort | Ocho Rios</option>
                                    <option value="negril">Foote Prints On The Sand | Negril</option>
                                    <option value="runaway bay">Franklyn D. Resort &amp; Spa | Runaway Bay</option>
                                    <option value="negril">Fun Holiday Beach Resort | Negril</option>
                                    <option value="ocho rios">Golden Seas | Ocho Rios</option>
                                    <option value="runaway bay">Grand Bahia Principe | Runaway Bay</option>
                                    <option value="negril">Grand Lido Negril Resort &amp; Spa | Negril</option>
                                    <option value="lucea">Grand Palladium Jamaica Resort &amp; Spa | Lucea</option>
                                    <option value="lucea">Grand Palladium Lady Hamilton Resort &amp; Spa | Lucea
                                    </option>
                                    <option value="negril">Grand Pineapple Resort | Negril</option>
                                    <option value="ocho rios">Goldeneye Hotel And Resort | Ocho Rios</option>
                                    <option value="montego bay">Half Moon | Montego Bay</option>
                                    <option value="negril">Hedonism II | Negril</option>
                                    <option value="runaway bay">Hedonism III | Runaway Bay</option>
                                    <option value="negril">Hidden Paradise | Negril</option>
                                    <option value="negril">Hilltop Villas | Negril</option>
                                    <option value="montego bay">Hilton Rose Hall Resort &amp; Spa | Montego Bay</option>
                                    <option value="ocho rios">Hisbiscus Lodge | Ocho Rios</option>
                                    <option value="negril">Hog Heaven | Negril</option>
                                    <option value="montego bay">Holiday Inn Resort, Montego Bay | Montego Bay</option>
                                    <option value="negril">Home Sweet Home | Negril</option>
                                    <option value="trelawny">Excellence Oyster Bay | Trelawny</option>
                                    <option value="montego bay">Hotel Gloriana | Montego Bay</option>
                                    <option value="montego bay">Hyatt Ziva Rosehall | Montego Bay</option>
                                    <option value="montego bay">Iberostar Grand Rose Hall | Montego Bay</option>
                                    <option value="montego bay">Iberostar Rose Hall Beach | Montego Bay</option>
                                    <option value="montego bay">Iberostar Rose Hall Suites | Montego Bay</option>
                                    <option value="negril">Idle Awhile Resort | Negril</option>
                                    <option value="montego bay">Jamaica Grandiosa Resort | Montego Bay</option>
                                    <option value="ocho rios">Jamaica Inn Hotel | Ocho Rios</option>
                                    <option value="ocho rios">Jewel Dunns River Resort And Spa | Ocho Rios</option>
                                    <option value="montego bay">Jewel Grande Montego Bay | Montego Bay</option>
                                    <option value="runaway bay">Jewel Paradise Cove Beach Resort &amp; Spa | Runaway Bay
                                    </option>
                                    <option value="runaway bay">Jewel Runaway Bay Beach &amp; Golf Resort | Runaway Bay
                                    </option>
                                    <option value="negril">Khus Khus Negril | Negril</option>
                                    <option value="negril">Kuyaba Negril | Negril</option>
                                    <option value="negril">Legends Beach Hotel | Negril</option>
                                    <option value="trelawny">Mangos Jamaica | Trelawny</option>
                                    <option value="montego bay">Melia Braco Village | Montego Bay</option>
                                    <option value="negril">Merril's Beach Resort | Negril</option>
                                    <option value="montego bay">Montego Bay Club Resort | Montego Bay</option>
                                    <option value="negril">Moonlight Villas | Negril</option>
                                    <option value="negril">Negril Beach Club | Negril</option>
                                    <option value="negril">Negril Beach Condos | Negril</option>
                                    <option value="negril">Negril Cabins Resort | Negril</option>
                                    <option value="negril">Negril Escape | Negril</option>
                                    <option value="negril">Negril Idle Away | Negril</option>
                                    <option value="negril">Negril Inn | Negril</option>
                                    <option value="negril">Negril Palm Beach | Negril</option>
                                    <option value="negril">Negril Tree House Resort | Negril</option>
                                    <option value="montego bay">Oasis At Sunset Hotel | Montego Bay</option>
                                    <option value="negril">Ocean Edge Resort | Negril</option>
                                    <option value="ocho rios">Ocean Sands Resort | Ocho Rios</option>
                                    <option value="negril">Our Past Time Villas | Negril</option>
                                    <option value="montego bay">Palm View Guest House | Montego Bay</option>
                                    <option value="montego bay">Paradise Clarridge View | Montego Bay</option>
                                    <option value="montego bay">Paradise Coconut Cottage | Montego Bay</option>
                                    <option value="ocho rios">Paradise L'Horizon | Ocho Rios</option>
                                    <option value="negril">Paradise View Hotel | Negril</option>
                                    <option value="ocho rios">Pier View Apts. | Ocho Rios</option>
                                    <option value="negril">Point Village Resort | Negril</option>
                                    <option value="montego bay">Polkerris Bed &amp; Breakfast | Montego Bay</option>
                                    <option value="negril">Pure Garden Resort | Negril</option>
                                    <option value="negril">Rant N' Rave | Negril</option>
                                    <option value="ocho rios">Reggae Hostel Ocho Rios | Ocho Rios</option>
                                    <option value="montego bay">Relax Resort | Montego Bay</option>
                                    <option value="montego bay">Ridgeway Guest House | Montego Bay</option>
                                    <option value="montego bay">RIU Montego Bay | Montego Bay</option>
                                    <option value="negril">RIU Negril | Negril</option>
                                    <option value="ocho rios">RIU Ocho Rios | Ocho Rios</option>
                                    <option value="montego bay">Riu Palace Montego Bay | Montego Bay</option>
                                    <option value="negril">RIU Palace Tropical Bay | Negril</option>
                                    <option value="montego bay">RIU Reggae | Montego Bay</option>
                                    <option value="negril">Rock Cliff Hotel | Negril</option>
                                    <option value="negril">Rock House Hotel | Negril</option>
                                    <option value="negril">Rondel Village | Negril</option>
                                    <option value="negril">Rooms On The Beach Negril | Negril</option>
                                    <option value="ocho rios">Rooms On The Beach Ocho Rios | Ocho Rios</option>
                                    <option value="negril">Roots Bambo Beach | Negril</option>
                                    <option value="montego bay">Round Hill Hotel &amp; Villas | Montego Bay</option>
                                    <option value="runaway bay">Royal Decameron Club Caribbean | Runaway Bay</option>
                                    <option value="runaway bay">Royal Decameron Fun Caribbean | Runaway Bay</option>
                                    <option value="montego bay">Royal Decameron Montego Bay | Montego Bay</option>
                                    <option value="ocho rios">Sandals Royal Plantation | Ocho Rios</option>
                                    <option value="montego bay">Royalton Blue Waters | Montego Bay</option>
                                    <option value="negril">Royalton Negril | Negril</option>
                                    <option value="montego bay">Royalton White Sands Resort | Montego Bay</option>
                                    <option value="runaway bay">Runaway Bay HEART Hotel | Runaway Bay</option>
                                    <option value="negril">Samsara Hotel | Negril</option>
                                    <option value="ocho rios">Sand Castles | Ocho Rios</option>
                                    <option value="ocho rios">Sandals Grande Ocho Rios | Ocho Rios</option>
                                    <option value="montego bay">Sandals Inn Luxury Resort | Montego Bay</option>
                                    <option value="montego bay">Sandals Montego Bay | Montego Bay</option>
                                    <option value="negril">Sandals Negril Beach Resort &amp; | Negril</option>
                                    <option value="montego bay">Sandals Royal Caribbean Resort | Montego Bay</option>
                                    <option value="ocho rios">Sandcastles Resort | Ocho Rios</option>
                                    <option value="negril">Sandi Sand Beach Resort | Negril</option>
                                    <option value="negril">Sandy Haven Resort | Negril</option>
                                    <option value="ocho rios">Sea Palms | Ocho Rios</option>
                                    <option value="negril">Sea Splash Resort | Negril</option>
                                    <option value="negril">Seashore Bay Beach Resort | Negril</option>
                                    <option value="negril">Secret Cabins On Negril Beach | Negril</option>
                                    <option value="montego bay">Secrets St. James Montego Bay | Montego Bay</option>
                                    <option value="ocho rios">Shaw Park Beach Hotel | Ocho Rios</option>
                                    <option value="negril">Shields Negril | Negril</option>
                                    <option value="montego bay">Silent Waters Villa | Montego Bay</option>
                                    <option value="trelawny">Silver Sands Hotel | Trelawny</option>
                                    <option value="ocho rios">Silver Seas Resort Hotel | Ocho Rios</option>
                                    <option value="negril">Summerset Village | Negril</option>
                                    <option value="montego bay">Sunscape Splash Montego Bay Resort And Spa | Montego Bay
                                    </option>
                                    <option value="montego bay">Sunscape Cove | Montego Bay</option>
                                    <option value="negril">Sunset At The Palms | Negril</option>
                                    <option value="ocho rios">Sunset Jamaica Grande | Ocho Rios</option>
                                    <option value="negril">Sunset On The Beach Resort | Negril</option>
                                    <option value="negril">Sunset On The Cliffs Resort | Negril</option>
                                    <option value="negril">Tensing Pen Hotel | Negril</option>
                                    <option value="montego bay">The Atrium | Montego Bay</option>
                                    <option value="negril">The Caves | Negril</option>
                                    <option value="negril">The Negril Escape Resort &amp; Spa | Negril</option>
                                    <option value="negril">The Oasis Resort | Negril</option>
                                    <option value="negril">The Palms Resort | Negril</option>
                                    <option value="montego bay">The Palmyra A Solis Resort &amp; Spa | Montego Bay
                                    </option>
                                    <option value="negril">The Spa Retreat - West End Negril | Negril</option>
                                    <option value="montego bay">The Wexford Hotel | Montego Bay</option>
                                    <option value="negril">Thrills Hotel | Negril</option>
                                    <option value="montego bay">Toby's Resort | Montego Bay</option>
                                    <option value="ocho rios">Tower Cloisters Resort | Ocho Rios</option>
                                    <option value="negril">Travellers Beach Resort | Negril</option>
                                    <option value="montego bay">The Tryall Club | Montego Bay</option>
                                    <option value="ocho rios">Turtle Beach Towers | Ocho Rios</option>
                                    <option value="negril">Whistling Bird | Negril</option>
                                    <option value="negril">White Sands Cottages | Negril</option>
                                    <option value="negril">Xtabi Resort | Negril</option>
                                    <option value="ocho rios">Moon Palace Jamaica | Ocho Rios</option>
                                    <option value="negril">Other Location (not listed) | Negril</option>
                                    <option value="lucea">Other Location (not listed) | Lucea</option>
                                    <option value="outer montego bay - west">Other Location (not listed) | Outer Montego
                                        Bay - West</option>
                                    <option value="montego bay">Other Location (not listed) | Montego Bay</option>
                                    <option value="ironshore">Other Location (not listed) | Ironshore</option>
                                    <option value="iberostar">Other Location (not listed) | Iberostar</option>
                                    <option value="trelawny">Other Location (not listed) | Trelawny</option>
                                    <option value="braco">Other Location (not listed) | Braco</option>
                                    <option value="runaway bay">Other Location (not listed) | Runaway Bay</option>
                                    <option value="ocho rios">Other Location (not listed) | Ocho Rios</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-row-block">
                            <div class="d-flex flex-wrap row-form-div">
                                <div class="one-half left-one-half">
                                    ...
                                    <input class="input-box" type="number" value="1" min="1" step="1" max="100"
                                        id="pickup_num_adults" required="">
                                </div>
                                <div class="one-half right-one-half">
                                    <span class="label-span">Number of Children (Ages 3-11)</span>
                                    <input class="input-box" type="number" value="0" min="0" step="1" max="100"
                                        id="pickup_num_children" required="">
                                </div>
                            </div>
                        </div>
                        <div class="form-row-block">
                        ...
                        <div class="tour_total_pricing">
                            ...
                            <h4 class="price" id="tour_price">$50.00</h4>
                        </div>
                        <div class="submit-button-cover"><button type="submit"
                                class="form-tour-booking-button single_add_to_cart_button button disabled" style="">Book
                                now</button></div>
                    </div>
                </div>
