...
<div id="main-content">
        ...
        <div class="container">
            <div class="row align-items-center no-margin">
                <div class="col-md-6">
                    ...
                    <hr class="divider" />
                    <p class="no-margin">Kiuki Tours is pleased to offer professional transportation for visitors, business executives, and various groups to their destination throughout Jamaica.</p>
                </div>
                <div class="col-md-6">
        ...
        <div>
          ...
          <div class="d-flex align-items-center product-item-content">
              <div class="inner-product-content">
                  ...
                  <div class="product-excerpt">Enjoy the scenic drive to the relaxed town of Negril. Stop and enjoy scenic views while en route to a day filled with sun and shopping.</div>
                  <div class="more-btn-cover"><a class="more-btn" href="#">More Details</a></div>
              </div>
              </div>
          </div>
        </div>
        <div>
          ...
          <div class="d-flex align-items-center product-item-content">
              <div class="inner-product-content">
                  ...
                  <div class="product-excerpt">Enjoy a guided tour through the River Gardens, while learning a brief history of our original inhabitants – the Taino Indians.</div>
                  <div class="more-btn-cover"><a class="more-btn" href="#">More Details</a></div>
              </div>
              </div>
          </div>
        ...
        <div>
          ...
          <div class="d-flex align-items-center product-item-content">
              <div class="inner-product-content">
                  ...
                  <div class="product-excerpt">Explore the natural wonder that is Konoko Falls. Enjoy a guided tour through the River Gardens, while learning a brief history of our original inhabitants – the Taino Indians.</div>
                  <div class="more-btn-cover"><a class="more-btn" href="#">More Details</a></div>
              </div>
              </div>
          </div>
    ...
    <a href="#" class="btn-more-tour"><span class="arrow-span"><i aria-hidden="true" class="fas fa-long-arrow-alt-right"></i></span><span class="text-span">More Tours <i aria-hidden="true" class="fas fa-long-arrow-alt-right"></i></span></a>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="bg-shape-bottom" data-negative="false"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.5 27.8" preserveAspectRatio="none" style="
    ">
    ...
    <h4>24/7 Support</h4>
    <p class="no-margin">Kiuki Tours is open everyday to help our customers! Don't hesitate to contact us.</p>
    </div>
    </div>
    </div>
    </div>
    ...
    <a href="#" class="post-read-more">Read More<i aria-hidden="true" class="fa-fw fas fa-arrow-right"></i></a>
    </div>
    </div>
    </div>
    </div>
